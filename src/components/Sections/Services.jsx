          ...
          <ServiceBoxRow className="flex">
            ...
            <ServiceBoxWrapper>
              <ServiceBox
                ...
                subtitle="Embedded Systems Development"
                subtitle1="IoT Solutions"
              />  
            </ServiceBoxWrapper>
            <ServiceBoxWrapper>
              <ServiceBox
            ...
            <ServiceBoxWrapper>
              ...
              subtitle="Circuit Testing"
              subtitle1="Functional Testing" />
            </ServiceBoxWrapper>
          </ServiceBoxRow>
        </div>
          ...
          <div className="container">
            <Advertising className="flexSpaceCenter">
              <AddLeft>
                ...
                <h2 className="font40 extraBold">A Company of Creativity</h2>
                <p className="font12">
                Agastya Global Circuits is a Leading provider of circuit design and manufacturing solutions, 
                specializing in custom PCBs and testing services. We deliver high-quality, 
                reliable electronics tailored to meet diverse industry needs.
                </p>
